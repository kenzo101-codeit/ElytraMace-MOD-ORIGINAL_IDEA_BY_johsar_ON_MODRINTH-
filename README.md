...
| Loader   | Status            | Notes                           | tested?                 |
| -------- | -----------       | ------------------------------- | ----------------------- |
| Fabric   | ✅ Supported      | Uses Fabric Loader + Fabric API | (tested)                |
| Forge    | ✅ Not Supported? | JavaFML (Forge 51+)             | (tested on personal pc) |
| NeoForge | ✅ Not Supported? | NeoForge 21+                    | (tested on personal pc) |
